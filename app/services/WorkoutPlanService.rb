class WorkoutPlanService
  ...
  def get_content
  	return $redis.get(content_name)
  end

  def content_name
  	return "content_#{current_user}"
  end
  ...
  def get_step_total
  	return $redis.get(step_total)
  end

  def step_total
  	return "step_total_#{current_user}"
  end
  ...
  def get_step
  	return $redis.get(step)
  end

  def step
  	return "step_#{current_user}"
  end
